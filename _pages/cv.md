...
Position in traffic research group. Writting data processing pipelines for qualitative and quantitative traffic research. Notable projects: 
...
- Was responsible for the course in microscopic traffic simulation based on [Eclipse SUMO](https://www.eclipse.org/sumo/) and Python. Materials can be found [here](https://github.com/TRG-BUILD/sumo_course/tree/master/course2021).
